...
for i in range(0,len(MSSubClass)-1):
  ...
  requestPrediction = model_pb2.Features(MSSubClass = MSSubClass[i], LotArea = LotArea[i], YearBuilt = YearBuilt[i], BedroomAbvGr = BedroomAbvGr[i], TotRmsAbvGrd = TotRmsAbvGrd[i])
